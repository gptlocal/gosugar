...
func TestBufferString(t *testing.T) {
	...
	lang.Must2(buffer.WriteString(payload))
...
func TestBufferByte(t *testing.T) {
	...
	{
		buffer := StackNew()
		lang.Must2(buffer.WriteString("HELLOWORLD"))
