...
type pipeOption struct {
	...
	onTransmission  func(buffer bufio.MultiBuffer) bufio.MultiBuffer
}
...
func OnTransmission(hook func(mb bufio.MultiBuffer) bufio.MultiBuffer) Option {
...
func New(opts ...Option) (*Reader, *Writer) {
	p := &pipe{
		readSignal:  concurrent.NewNotifier(),
		writeSignal: concurrent.NewNotifier(),
		done:        done.New(),
