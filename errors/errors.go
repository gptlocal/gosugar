...
import (
	...
	"github.com/gptlocal/gosugar/log"
	"github.com/gptlocal/gosugar/text"
)

const trim = len("github.com/gptlocal/gosugar/")
...
func (err *Error) Error() string {
	...
	for _, prefix := range err.prefix {
		builder.WriteByte('[')
		builder.WriteString(text.ToString(prefix))
		builder.WriteString("] ")
	}
